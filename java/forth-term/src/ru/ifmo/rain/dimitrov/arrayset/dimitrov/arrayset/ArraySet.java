package ru.ifmo.rain.dimitrov.arrayset.dimitrov.arrayset;
...
public class ArraySet<E> extends AbstractSet<E> implements NavigableSet<E> {
    ...
    public NavigableSet<E> descendingSet() {
        return new ru.ifmo.rain.dimitrov.arrayset.ArraySet<E>(new ReversibleList<E>(array, true), Collections.reverseOrder(comparator));
    }
    ...
    private NavigableSet<E> subSetImpl(E fromElement, boolean fromInclusive, E toElement, boolean toInclusive) {
        ...
        if (fromIndex > toIndex) {
            return new ru.ifmo.rain.dimitrov.arrayset.ArraySet<>(comparator);
        }
        return new ru.ifmo.rain.dimitrov.arrayset.ArraySet<E>(array.subList(fromIndex, toIndex + 1), comparator);
    }
